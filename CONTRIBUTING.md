...
For patch contributions, see our [Developer Documentation](https://github.com/nasa-jpl/lunasynth/wiki/Developer-Documentation) for more details on how to set up your local environment, to best contribute to our project. 

At a minimum however to submit patches (if using Git), you'll want to ensure you have:
1. An account on GitHub.
2. Git installed on your local machine.
3. The ability to edit, build, and test LUNASYNTH on your local machine. Again, see our [README.md](README.md) or detailed developer guide for more details 
...
- [Issue tracking system](https://github.com/nasa-jpl/lunasynth/issues) - a regularly monitored area to report issues with our software or propose changes
- [Discussion forum](https://github.com/nasa-jpl/lunasynth/discussions) - a place to ask questions, propose new features, or discuss the project with other contributors
...
Make sure people are aware you're working on a patch! Check out our [issue tracking system](https://github.com/nasa-jpl/lunasynth/issues) and find an open issue you'd like to work against, or alternatively file a new issue and mention you're working on a patch.
...
See our list of issues at: https://github.com/nasa-jpl/lunasynth/issues
...
- **Check for duplicates** - there may be a bug report already describing your issue, so check the [issue tracking system](https://github.com/nasa-jpl/lunasynth/issues) first.

Here's some guidance on submitting a bug issue:
1. Navigate to our [issue tracking system](https://github.com/nasa-jpl/lunasynth/issues) and file a new issue
...
- **Check for duplicates** - there may be a new feature issue already describing your issue, so check the [issue tracking system](https://github.com/nasa-jpl/lunasynth/issues) first
...
Take a look at our [pull requests tracking system](https://github.com/nasa-jpl/lunasynth/pulls), and try the following options for providing a review:
...
⚠️ It's **highly** advised that you take a look at our [issue tracking system](https://github.com/nasa-jpl/lunasynth/issues) before considering any code contributions. Here's some guidelines:
...
⚠️ It's **highly** advised that you take a look at our [issue-tracking system](https://github.com/nasa-jpl/lunasynth/issues) before considering any documentation contributions. Here's some guidelines:
...
- Hosted documentation
  - [LUNASYNTH Wiki Main-page](https://github.com/nasa-jpl/lunasynth/wiki) - Wiki pages for more detailed information about the project
    - [Developer Documentation](https://github.com/nasa-jpl/lunasynth/wiki/Developer-Documentation) - a page detailing how to set up your local development environment 
...
1. Clone the LUNASYNTH wiki repository to your local machine `git clone https://github.com/nasa-jpl/lunasynth.wiki.git`
...
- Answer open questions in our [discussion forum](https://github.com/nasa-jpl/lunasynth/discussions)
- Answer open questions mentioned in our [issue tracking system](https://github.com/nasa-jpl/lunasynth/issues)
